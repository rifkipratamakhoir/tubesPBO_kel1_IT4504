 ...
 */
import java.sql.*;
public class LogInRifkiPratamaKhoir extends javax.swing.JFrame {

    /** Creates new form LogIn */
    public LogInRifkiPratamaKhoir() {
        initComponents();
    }
    ...
    private void loginBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginBTNActionPerformed
        ...
        try   {
          /*  Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
            ...
            if(str.equals(PWord))
            {
                 MenuKevinYoelBernhard m = new MenuKevinYoelBernhard(Id);
                  m.setVisible(true);
    ...
    private void regLBLMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_regLBLMouseClicked
        RegisterDimasWahyuNugroho r = new RegisterDimasWahyuNugroho();
        r.setVisible(true);
        this.setVisible(false);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LogInRifkiPratamaKhoir().setVisible(true);
            }
        });
    }
